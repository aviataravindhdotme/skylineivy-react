        ...
        <div>
            <div css={viewItemContainer}>
                ...
                <div css={detailsContainer}>
                    ...
                    <p>Lorem ipsum, dolor sit amet consectetur adipisicing elit.
                        Iusto velit dolores repudiandae animi quidem, eveniet quod dolor facilis dicta eligendi ullam
                        error.
                        Assumenda in fugiat natus enim similique nam itaque.</p>
            ...
            <div css={reviewContainer}>
                ...
                <StarRating size={15} count={5} innerRadius={20}
                            ...
                            initialRating={starrating}/>
                <p>{review}</p>
                <p>Lorem ipsum dolor sit amet consectetur adipisicing elit. Rerum iusto placeat consequatur voluptas sit
                    mollitia ratione autem, atque sequi odio laborum, recusandae quia distinctio voluptatibus sint, quae
                    aliquid possimus exercitationem.</p>
